...
private:
	...
	{
		POINT pCenter;
		CSageBitmap cRingMask	;
		CSageBitmap cGlowMask	;
		CSageBitmap cShadowMask	;
	};
	...
	CSageBitmap m_cShadowMask		;
	CSageBitmap m_cWheelMask		;
	CSageBitmap m_cPlane			;	
	CSageBitmap m_cTriMask			;
	CSageBitmap m_cTriPlane			;

	CSageBitmap m_cBackground		;
	CSageBitmap m_cOutput			;
	CSageBitmap m_cParentBg			;
