...
#include "vkw_keydefs.h"        // Include keyword definitions for ckwargs namespace
...
namespace vkwType
{
    ...
    public:        
        ...
        bool isEmpty() const { return package.key == (decltype(package.key)) -1; }
...
} } // namespace ckwargs_drawlinevector
