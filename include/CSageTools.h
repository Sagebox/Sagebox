...
public:
	...
	static bool ResizeLanzcos(Sage::CSageBitmap & cSource,Sage::CSageBitmap & cDest); 
	...
	static Sage::CSageBitmap ResizeLanzcos(Sage::RawBitmap_t & stSource,int iNewWidth,int iNewHeight,bool * bSuccess = nullptr);
	static Sage::CSageBitmap ResizeLanzcos(Sage::CSageBitmap & cSource,int iNewWidth,int iNewHeight,bool * bSuccess = nullptr);

	static Sage::CSageBitmap BilinearResize(Sage::RawBitmap_t & stSource,int iNewWidth,int iNewHeight,bool * bSuccess = nullptr);
	static Sage::CSageBitmap BilinearResize(Sage::CSageBitmap & cSource,int iNewWidth,int iNewHeight,bool * bSuccess = nullptr);
