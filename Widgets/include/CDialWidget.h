...
private:
	...
	CSageBitmap m_cFaceOut;
	CSageBitmap m_cFaceScr;
	CSageBitmap m_cFaceOrg;
	CSageBitmap m_cRingMask;
	CSageBitmap m_cRingHigh;
	CSageBitmap m_cCalcMask;

	CSageBitmap m_cHandleGraphic;
	CSageBitmap m_cHandleGlowMask;
